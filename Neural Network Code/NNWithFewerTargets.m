...
%amcl_gazebo_error = [ joinedsetsturtlebotteleop2(:,'ErrorSum'); joinedsetsturtlebotteleop3(:,'ErrorSum'); joinedsetsturtlebotteleop4(:,'ErrorSum'); joinedsetsturtlebotteleop5(:,'ErrorSum')];
...
%inputs = [ table2array(joinedsetsturtlebotteleop2(:,'CloudSpreadSum')); table2array(joinedsetsturtlebotteleop3(:,'CloudSpreadSum')); table2array(joinedsetsturtlebotteleop4(:,'CloudSpreadSum')); table2array(joinedsetsturtlebotteleop5(:,'CloudSpreadSum'))]';
...
%new_inputs = [table2array(joinedsetsturtlebotteleop1(:,'CloudSpreadSum'))]';
